...
const TopHero = () => {
	...
	return (
		<section className='hero min-h-full bg-gradient-to-r from-accent to-success'>
			<div className='hero-overlay bg-opacity-50'></div>
			<div
				className={
					'hero-content w-full text-center text-neutral-content py-16 sm:py-10 md:py-4'
				}
			>
				<div className='max-w-md flex flex-col gap-5 xl:gap-8 items-center'>
					...
					<div className={styles.hidden}>
						...
						<form>
							...
							<div className='flex flex-col sm:block sm:join'>
								<input
